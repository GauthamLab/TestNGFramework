...
Feature: Feature file to add master and delete the existing master
  ...
  Scenario: Load data from Excel workbook
    Given I load the Excel workbook "C:\Users\Rajesh\git\TestNGFramework\src\test\resources\testData\newCTLapp.xlsx" and sheet "TitleMaster"
  ...
  Scenario Outline: Login to Application
    ...
    Then Search for Employee"<Employee>"
